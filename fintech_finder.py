...
candidate_database = {
    "Lane": ["Lane", "0x27b5F99F525685f6bCadaA0529c15962D777C59B", "4.3", .20, "Images/lane.jpeg"],
    "Ash": ["Ash", "0x683Ce9c567dC3618989CAB9FCBc8E03525A1D04f", "5.0", .33, "Images/ash.jpeg"],
    "Jo": ["Jo", "0xb6B6E29aB0180C43DB66b781d1A7e6585650E8A7", "4.7", .19, "Images/jo.jpeg"],
    "Kendall": ["Kendall", "0x5849C4d8200807Afd4252cf51398DAaA81Fa27Ec", "4.1", .16, "Images/kendall.jpeg"]
}
...
getbal = get_balance(w3, account.address)
st.sidebar.write(getbal)
